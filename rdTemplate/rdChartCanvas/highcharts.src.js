...
(function () {
    ...
    Tick.prototype = {
        ...
        render: function (index, old, opacity) {
            ...
            if (tickWidth && tickLength && defined(renderer)) {
            ...
            if (!categories && !axis.axisPointRange && !axis.usePercentage && !isLinked && defined(axis.min) && defined(axis.max)) {
                ...
                if (length) {
                    if (!defined(options.min) && !defined(axis.userMin) && minPadding &&
                        (axis.dataMin < 0 || !axis.ignoreMinPadding) || axis.chart.options.chart.type == "gauge" || (axis.series[0] && axis.series[0].type && axis.series[0].type.endsWith("gauge"))) {
                    ...
                    else if (!defined(options.min) && !defined(axis.userMin) &&axis.dataMin < 0 && !axis.chart.angular) {
 ...
 */
    ...
    Pointer.prototype = {
        ...
        setDOMEvents: function () {
            if (defined(this.chart.container)) {
                var pointer = this,
    ...
    Chart.prototype = {
        ...
        drawChartBox: function () {
            ...
            if (chartBorderWidth || chartBackgroundColor) {
                if (!chartBackground) {
                    ...
                    if (defined(renderer) && chart.angular) {
            ...
            if (defined(renderer)) {
                // Plot background
                if (plotBackgroundColor && defined(renderer)) {
                    if (!plotBackground) {
                ...
                if (plotBackgroundImage && defined(renderer)) {
                    if (!plotBGImage) {
        ...
        render: function () {
            ...
            // The series
            if (!chart.seriesGroup && defined(renderer)) {
            ...
            if (chart.angular) {
                if (options.yAxis[0]) {
                    ...
                    for (var i = 0; i < chart.series.length; i++) {
                        ...
                        if (serie.data[0] && serie.data[0].y < minBound)
 ...
 */
    ...
    Series.prototype = {
        ...
        plotGroup: function (prop, name, visibility, zIndex, parent) {
            ...
            if (defined(this.chart.renderer)) {
        ...
        render: function () {
            if (defined(this.chart.renderer)) {
                var series = this,
                    ...
                    animDuration = (defined(chart.renderer) && animation && !!series.animate && chart.renderer.isSVG && pick(animation.duration, 500)) || 0,
    ...
    extend(Series.prototype, {
        ...
        setVisible: function (vis, redraw) {
            ...
            // show or hide axis
            //xAxis
            var bShowxAxis = false;
            each(series.xAxis.series, function (currS) { bShowxAxis = bShowxAxis || currS.visible; });
            series.xAxis.showAxis = bShowxAxis;
            series.xAxis.options.showEmpty = bShowxAxis && series.xAxis.options.showEmpty;
            //yAxis
            var bShowyAxis = false;
            each(series.yAxis.series, function (currS) { bShowyAxis = bShowyAxis || currS.visible; });
            series.yAxis.showAxis = bShowyAxis;
            series.yAxis.options.showEmpty = bShowyAxis && series.yAxis.options.showEmpty;
            if (redraw !== false) {
                chart.redraw();
            }
